...
time.sleep(3)
print()
os.system("toilet -fmono12 -F gay Agent-C ")
print("\033[96m Code made by www.github.com/CharlieTheHack1")
print(" Youtube : https://www.youtube.com/c/CharlieTheHacker ")
print(" Twitter  https://twitter.com/CharlieTheHack1 ")
print(" Insta : https://instagram.com/7.7.7.7_hacker \033[0m")
print()
